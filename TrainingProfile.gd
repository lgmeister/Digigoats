...
func save_stats():
	...
	Global.active_goat.goat_max_health = which_goat_node.goat_max_health
	Global.active_goat.goat_current_health = which_goat_node.goat_current_health
