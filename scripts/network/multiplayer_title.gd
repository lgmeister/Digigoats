...
### Nodes ###
onready var join_grid = $"Frame/TabContainer/Join Game/join_grid"
onready var loading = $loading_screen
onready var loading_label = $loading_screen/Label
onready var server_ip_address = $"Frame/TabContainer/Join Game/join_ip_address"
onready var username = $Frame/Username
onready var animation = $AnimationPlayer
onready var color_pick = $Frame/color_pick
...
func load_servers():
	...
	var scene_instance = server_label_scene.instance()
	join_grid.add_child(scene_instance)
